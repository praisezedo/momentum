        ...
        <>
          <div className="flex flex-col items-center mt-7 border-blue-300 border rounded-2xl  justify-center gap-7 px-20 py-5" >
           ...
           <h1 className="flex justify-center items-center text-blue-900 font-bold text-3xl py-2">Add Goal</h1>
             ...
             {goalMessage && (
                <p className="text-black text-lg flex justify-center">{goalMessage}</p>
            )}
              </div>
            <div className="flex justify-start gap-3">
                ...
                <button className="bg-blue-900 text-white p-3 hover:opacity-50 hover:cursor-pointer rounded-2xl min-w-100" onClick={handleAddGoal}>
                    Add Goal
                </button>
